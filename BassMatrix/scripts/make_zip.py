...
def  main():
  ...
  installer = "\installer\BassMatrix Installer.exe"
   
  if demo:
    installer = "\installer\BassMatrix Demo Installer.exe"
  ...
  ZIPNAME = "BassMatrix-v" + FULLVERSIONSTR + "-win.zip"
  
  if demo:
    ZIPNAME = "BassMatrix-v" + FULLVERSIONSTR + "-win-demo.zip"
